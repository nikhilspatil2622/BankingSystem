...
<div class="intro-text">
                    ...
                    <hr class="star-light">
                    <p class="skills">Made By Nikhil Patil</p>
                    <p class="skills" style="font-style: italic;">Scroll to view more functionalities</p>
</div>
        ...
        <div class="container" >
            <div class="row" >
                <div class="col-lg-12 text-center" >
                    <h2 style="font-style: italic;">More Customers</h2>
...
<a href="customers.php" style="text-decoration: none;"><button class="btn btn-lg btn-default " style="background-color: #18bc9c;  margin:0 auto; display:block; ">View All Customers</button></a>
    ...
    <footer class="container" style="min-height:100px; background-color:#fff;color: #90EE90;text-align:center;padding-top:50px;">
        MADE BY Nikhil Patil © 2021 
    </footer>
</div>
